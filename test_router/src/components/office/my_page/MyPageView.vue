  ...
  <div class="my-page-wrap">
    <div class="my-page">
      <section class="profile-section">
        <div class="profile">
          <div class="profile-img-wrap">
            ...
            <span class="img-update-txt" @click="">프로필 사진 수정</span>
          </div>
          <div class="profile-info-wrap">
            <section class="info-name-section">
              <span class="info-name">{{list.user_name}}</span>
              <span class="pw-update-txt" @click="">비밀번호 수정</span>
            </section>
            ...
            <section class="user-delete-section">
              <span class="user-delete-btn" @click="">탈퇴하기</span>
            </section>
          </div>
        </div>
      </section>
      ...
      <section class="my-page-menu-section">
          <div id="reserve-menu" class="menu-box left-menu menu-top" @click="">
          ...
          <div id="mileage-menu" class="menu-box menu-top" @click="">
              <section class="menu-box-img-section">
          ...
          <div id="review-menu" class="menu-box left-menu" @click="">
              <section class="menu-box-img-section">
          ...
          <div id="question-menu" class="menu-box" @click="">
              <section class="menu-box-img-section">
